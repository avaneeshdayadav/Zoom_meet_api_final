<?php
    ...
    $data['duration'] 	= 39;   // In minutes
    $data['type'] 		= 2;    // This means it's a shedule meeting and will start at a given time only.
    $data['password'] 	= "12345";
...
<body>
  <div class="transparent"></div>
    ...
    <div style="font-weight: 500;font-size: 1.7rem;text-align: center;vertical-align: middle;color:#6b54ff;">Meeting with topic "<?php echo $response->topic; ?>" created.</div><br>
    <div class="meet_det_card shadow">
      <div style='border-bottom:2px solid #6b54ff;padding:1.2%;'><h5 style='text-align:center;color:black'> Any student with following meeting ID or Url can join this meeting.</h5></div>
      <div style='display:flex;' class="flex-container">
        <div class='meet-card-icon'><img src='img/meet.png' style='height:80%;width:80%;'></div>
        <div class='meet-card-content'>
          <?php
                  // echo "<pre>";
                  // print_r($response);
                  // echo "<pre>";
                  
                  echo "<b>Meeting ID: </b>". $response->id;
                  echo "<br>";
                  echo "<b>Meeting Password: </b>". $response->password;
                  echo "<br>";
                  echo "<b>Direct URL: </b>". "$response->join_url";
                  echo "<br>";
                  // echo "Meeting is created, To join ";
                  // echo "<a href='". $response->join_url ."' target='_blank'>Click Here</a>";
                  // echo "<br>";
    ...
    <div style="text-align:center;margin-top:-2%;"><button id='join_meet' type='button' class='btn btn-success' onclick="location.href='<?php echo $response->join_url;?>'">Join Meeting</button></div><br>

<?php
    ...
    class Zoom_Api
    {
        private $zoom_api_key = '5QHMBo2NTPCnvWzF2E520A';
        private $zoom_api_secret = '2rCeaEShX0avZGimLqfZnTofpoUZxshAfRAS';

        //function to generate JWT, This function returns a token and is called in function sendRequest().
    	...
    	{
            //Enter_Your_Email
            $request_url = "https://api.zoom.us/v2/users/avaneeshdyadav@gmail.com/meetings";    // Use the email which you used during creation of ur zoom account.
            ...
            $postFields = json_encode($data);   // Converting request data to json format.
            
                $ch = curl_init();
                curl_setopt_array($ch, array(
                CURLOPT_URL => $request_url,    // Url on which data is being sent.
                ...
                CURLOPT_POSTFIELDS => $postFields, // Data which is converted in json format.
                CURLOPT_HTTPHEADER => $headers,    // Here token generated by generateJWTKey() function is added.
                ));

                $response = curl_exec($ch); // Status of request sent by us to zoom
                $err = curl_error($ch);
                curl_close($ch);
                if (!$response) {
                        return $err;
